...
from paladin.pl_modules.joint import JointBetaBinomialLightningModule
from paladin.run import run
...
class ModuleWithCustomCheckpoint(JointBetaBinomialLightningModule):
